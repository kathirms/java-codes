            ...
            public static void main( String[] argu )
               {  
                  ...
                  System.out.print("\t\t\t ***Wellcome To Multi Level Parking System***\n\n");
                       ...
                       Display.display(parkingList);//display the parking lists
                       ...
                       while(continueOrExit=='y')
                          {    
                                ...
                                if(getChoice==1)
                                    {
                                         ParkingProcess.parkingProcess(parkingList);//call the parking process functon 
                               
                                         Display.display(parkingList);//call the display function 
                                    }
                                 //unparking process   
                               else if(getChoice==2)
                                    {
                               
                                        UnparkingProcess.unparkingProcess(parkingList);//call the unparking process function
