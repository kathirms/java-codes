                         ...
                         while( continueOrExit=='y' )
                              ...
                              {    
                                   ...
                                   if( getChoice==1 )
                                        ...
                                        {
                                             ParkingProcessClass.park( parkingLists );//call the parking process functon 
                                   ...
                                   //unparking process   
                               ...
                               
                                        {
                                             ...
                                             UnparkingProcessClass.unpark( parkingLists );//call the unparking process function
...
class ParkingProcessClass

     {
          ...
          static void park( ArrayList< MultiLevelParkingSystem > parkingLists )//park function
...
class UnparkingProcessClass

     {
          ...
          static void unpark( ArrayList< MultiLevelParkingSystem > parkingLists )//unpark function
